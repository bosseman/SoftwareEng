...
public class NBARostersScraper_Mark3 {
	...
	public static ArrayList<String> getNBARoster() throws IOException {
		...
		String[] teamName = { "hawks", "celtics", "nets", "hornets", "bulls", "cavaliers", "mavericks", "nuggets",
				"pistons", "warriors", "rockets", "pacers", "clippers", "lakers", "grizzlies", "heat", "bucks",
				"timberwolves", "pelicans", "knicks", "thunder", "magic", "sixers", "suns", "blazers", "kings", "spurs",
		...
		for (int i = 0; i < teamName.length; i++) {
			...
			Elements playerName = document.select("p.nba-player-index__name").append("%"); // I append % in order to
																							// split them later
